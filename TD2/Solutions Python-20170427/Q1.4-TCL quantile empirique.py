...
Q_empirique_u = [np.sort(X[0,0:i])[int(np.ceil(i*u))-1] for i in range(1,n+1)] 
...
plt.plot(x,gaussienneLimite,"r", linewidth=1.5, label="Densite gaussienne de variance connue $u(1-u)/f(Q(u))^2$")
